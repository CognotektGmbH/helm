...
{{- include "rabbitmq.common.names.name" . -}}
{{- end -}}
...
{{- include "rabbitmq.common.names.fullname" . -}}
{{- end -}}
...
{{ include "rabbitmq.common.images.image" (dict "imageRoot" .Values.image "global" .Values.global) }}
{{- end -}}
...
{{ include "rabbitmq.common.images.image" (dict "imageRoot" .Values.volumePermissions.image "global" .Values.global) }}
{{- end -}}
...
{{ include "rabbitmq.common.images.pullSecrets" (dict "images" (list .Values.image .Values.volumePermissions.image) "global" .Values.global) }}
{{- end -}}
...
{{ include "rabbitmq.common.tplvalues.render" (dict "value" .Values.metrics.podAnnotations "context" $) }}
{{- end }}
{{- end -}}
